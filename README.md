...
- [Live Demo Link](https://book-store-8g76.onrender.com/)
...
```sh
  cd my-folder
  git clone https://github.com/Tekhlay/react-bookstore.git
```
...
Feel free to check the [issues page](https://github.com/Tekhlay/react-bookstore/issues/).
